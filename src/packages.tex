...
%% Page layout
\usepackage[margin=1in,footskip=0.5in]{geometry} % Page layout customization
\usepackage[usegeometry,paper=297mm:210mm]{typearea} % Control type area with geometry
\usepackage{fancyhdr} % Page headers and footers
\usepackage{titlesec} % Section title formatting
\usepackage{titling} % Control title position
...
\usepackage{bookmark} % New bookmark organization for hyperref
...
%% Appendices
\usepackage[toc,page,title]{appendix} % Enhanced appendix handling
...
\usepackage{tikz}
\usetikzlibrary{decorations.pathreplacing,calligraphy,tikzmark,calc,math}